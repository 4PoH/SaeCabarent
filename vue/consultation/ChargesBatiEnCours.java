...
public class ChargesBatiEnCours extends JFrame implements ActionListener {
	...
	public ChargesBatiEnCours() {
		...
		setTitle("Charges bâtis en cours");
		...
		JLabel TitreChargesBatiEnCours = new JLabel("Charges bâtis en cours");
		TitreChargesBatiEnCours.setFont(new Font("Tahoma", Font.BOLD, 20));
		TitreChargesBatiEnCours.setBounds(10, 10, 409, 29);
		contentPane.add(TitreChargesBatiEnCours);
