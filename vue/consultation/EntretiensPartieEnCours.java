...
public class EntretiensPartieEnCours extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EntretiensPartieEnCours frame = new EntretiensPartieEnCours();
	 ...
	 * Create the frame.
	 */
	public EntretiensPartieEnCours() {
		setBackground(new Color(240, 240, 240));
		setTitle("Entretiens des parties communes en cours");
		...
		JLabel TitreEntretiensPartieEnCours = new JLabel("Entretiens des parties communes en cours");
		TitreEntretiensPartieEnCours.setFont(new Font("Tahoma", Font.BOLD, 20));
		TitreEntretiensPartieEnCours.setBounds(10, 10, 430, 29);
		contentPane.add(TitreEntretiensPartieEnCours);
	...
	public void actionPerformed(ActionEvent e) {
		switch(e.getActionCommand()){
			...
			case "Locations en cours":
				this.dispose();
				new EntretiensPartieEnCours().setVisible(true);
				break;
