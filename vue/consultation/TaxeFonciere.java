	...
	public TaxeFonciere() {
		...
		try {
			...
			while (rsTaxeFonciere.next()) {
				...
				String tottaxefonc = String.valueOf(rsTaxeFonciere.getFloat("totaltaxefonciere"));
				String totordmen = String.valueOf(rsTaxeFonciere.getFloat("totalorduremenagere"));
